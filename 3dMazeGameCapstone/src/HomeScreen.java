...
public class HomeScreen extends PApplet{
	...
	public void draw(){
		...
		rect(width/7, height/2, width/6, height/10);
		rect(width-width/7-width/6,height/2 , width/6, height/10);
		textSize(24);
		text("3D Maze", width/3 , height/4);
		textSize(16);
		fill(100);
		text("Easy Mode", width/7, height/2, width/7+width/6, 2*height/3+height/10);
		
		text("Hard Mode", width-width/7-width/6, height/2, width-width/7, 2*height/3+height/10);
